...
class MentorPreferences(tk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.model = MentorPreferenceModel(r"" + parent.get_db_path())
        self.org_model = OrganizationsModel(r"" + parent.get_db_path())
        self.mentor_model = MentorsModel(r"" + parent.get_db_path())
