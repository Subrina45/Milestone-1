...
class MentorMenu(tk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.mentors_model = MentorsModel(r"" + parent.get_db_path())
    ...
    def get_initial_frame(self, parent_frame):
        ...
        tk.Label(entries_container, text='Day:', font=mentorPreference.fonts.sub).grid(row = 6, column = 0, pady = 10)
        days = [
            "Monday",
            "Tuesday",
            "Wednesday",
        ...
        tk.Button(buttons_frame, text='Update', font=mentorPreference.fonts.mid,
        ...
        delete_btn = tk.Button(buttons_frame, text='Delete', font=mentorPreference.fonts.mid,
        ...
        search_by_org_entry = tk.Entry(search_frame, font=mentorPreference.fonts.sub)
